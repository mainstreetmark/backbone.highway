	...
	var HighwayCollection = ( function () {
		...
		HighwayCollection.protoype = {
			...
			_search: function ( options ) {
				if ( this.minimum !== {} && this._partial === true ) {
					var self = this;
					return new Promise( function ( success, fail ) {
						self.io.emit( 'search', options, function ( docs ) {
							Backbone.Collection.prototype.add.call( self, docs );
							success();
						} );
					} );
				} else {
			...
			where: function ( attrs, first ) {
				var self = this;
				return this._search( attrs )
					.then( function () {
						return Backbone.Collection.prototype.where.call( self, attrs, first );
					} );
