(function(Backbone, _) {
	...
	/**
	 * HighwayModel
	 * This will become Backbone.Highway.Model further down the line
	 * This is basically a regular Backbone model with the exception
	 * that it can read and write nested objects
	 */
		...
		HighwayCollection.protoype = {
			...
			_childChanged: function(snap) {
				...
				var item = _.find(this.models, function(child) {
					return child.get(idAttribute) == model[idAttribute];
				});
